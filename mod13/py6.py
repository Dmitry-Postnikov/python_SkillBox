...
sql_request_drop_all_rows = """DELETE FROM table_friendship_schedule"""

sql_request_get_all_employees = """SELECT id, preferable_sport FROM table_friendship_employees"""

sql_request_insert_employee = """INSERT INTO table_friendship_schedule (employee_id, date) VALUES (?,?)"""
